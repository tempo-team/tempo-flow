...
-- CreateIndex
CREATE INDEX "Flow_enabled_idx" ON "Flow"("enabled");
...
-- CreateIndex
CREATE INDEX "NodeRun_flowRunId_idx" ON "NodeRun"("flowRunId");
...
-- AddForeignKey
ALTER TABLE "NodeRun" ADD CONSTRAINT "NodeRun_flowRunId_fkey" FOREIGN KEY ("flowRunId") REFERENCES "FlowRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;
